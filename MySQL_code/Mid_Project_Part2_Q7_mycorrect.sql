...
CREATE TEMPORARY TABLE try2
SELECT
	website_session_id,
    pageview_url,
    MAX(home_page) AS home_made_it,
    MAX(lander1_page) AS lander1_made_it,
...
SELECT
    ...
    (CASE WHEN home_made_it = 1 THEN 'to_home' WHEN lander1_made_it = 1 THEN 'to_lander1' ELSE NULL END) AS lander,
--     COUNT(DISTINCT CASE WHEN lander1_made_it = 1 THEN website_session_id ELSE NULL END) AS to_lander1,
