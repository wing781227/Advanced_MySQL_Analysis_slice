...
GROUP BY sessions_seeing_cart.time_period,
		sessions_seeing_cart.cart_session_id
HAVING 
	MIN(website_pageviews.website_pageview_id) IS NOT NULL;  -- Important
...
FROM sessions_seeing_cart
	INNER JOIN orders	-- Important
		ON sessions_seeing_cart.cart_session_id = orders.website_session_id;	-- Important
